...
/**
 * The "analysis" table, used for counting interactions without a classification.
 ...
 */
@Entity
@Table(name = "MV_ALL_INTERACTION")
public class AnalysisView implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6082557993341468394L;
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY, targetEntity = Classification.class)
